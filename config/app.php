...
return [
    ...
    */
    ...
    'aliases' => [
         ...
         * EGWK Facades
         */
        'Reader' => App\Facades\Reader::class,
        'SearchSimilar' => App\Facades\Reader\SearchSimilar::class,
        'SabbathSchool' => App\Facades\SabbathSchool::class,
        'Hymnal' => App\Facades\Hymnal::class,
