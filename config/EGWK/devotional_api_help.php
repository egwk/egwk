...
return [
    'all' => [
        ...
        'uri' => '/devotional/{id}',
        'uri_example' => '/devotional/hu-reggelidicseret',
    ...
    'year' => [
        ...
        'uri_example' => '/devotional/year/2019/hu-reggelidicseret',
    ...
    'today' => [
        ...
        'uri_example' => '/devotional/today/hu-reggelidicseret',
    ...
    'date' => [
        ...
        'uri_example' => '/devotional/2019-02-28/hu-reggelidicseret',
